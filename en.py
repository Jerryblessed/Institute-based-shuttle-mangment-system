# Strings / localization file for Hopeful
...
# Quantity of a vehicle in stock
in_stock_format_string = "{quantity} available"

# Copies of a vehicle in cart
in_cart_format_string = "{quantity} space(s) booked"
...
conversation_open_admin_menu = "You are a 💼 <b>driver</b> of this supply!\n" \
...
# Conversation: select a vehicle to edit
conversation_admin_select_product = "✏️ What vehicle do you want to edit?"

# Conversation: select a vehicle to delete
conversation_admin_select_product_to_delete = "❌ What vehicle do you want to delete?"

# Conversation: select a user to edit
conversation_admin_select_user = "Select an user to edit."

# Conversation: click below to pay for the purchase
conversation_cart_actions = "<i>See and book space(s) by scrolling up and pressing the " \
                            "Add button below" \
                            "When you're done, go back to this " \
                            "message and" \
                            " press the Done button below.</i>"

# Conversation: confirm the cart contents
conversation_confirm_cart = "Confirm the number of booked space(s) for the following vehicles:\n" \
                            "{product_list}" \
...
conversation_confirm_admin_promotion = "Are you sure you want to promote this user to 💼 driver?\n" \
...
conversation_switch_to_user_mode = " You are switching to 👤 Customer mode.\n" \
                                   "If you want to go back to the 💼 driver menu, restart the conversation with /start."
...
# Admin menu: add vehicle
menu_add_product = "✨ New vehicle"

# Admin menu: delete vehicle
menu_delete_product = "❌ Delete vehicle"
...
menu_contact_shopkeeper = "👨‍💼 Contact the supply"

# Menu: generate transactions .csv file
menu_csv = "📄 .csv"

# Menu: edit admins list
menu_edit_admins = "🏵 Edit drivers"
...
# Add vehicle: name?
ask_product_name = "What should the vehicle name be?"

# Add vehicle: description?
ask_product_description = "What should the vehicle description be?"

# Add vehicle: price?
ask_product_price = "What should the fare be for this vehicle ride?\n" \
                    "Enter <code>X</code> if don't want the vehicle ride to have a price."

# Add vehicle: image?
ask_product_image = "🖼 What image do you want the vehicle to have?\n" \
                    "\n" \
                    "<i>Send the photo, or Skip this phase and don't add any image.</i>"

# Order vehicle: notes?
ask_order_notes = "Input your RFID code?\n" \
                  "💼 It will be visible to the driver.\n" \
                  "\n" \
                  "<i>Send a message with the RFID code you want to leave, or press the Skip button below this" \
                  " message to leave nothing.</i>"

# Refund booked space(s): reason?
...
# Edit admin: can edit vehicles?
prop_edit_products = "Edit vehicles"
...
payment_cash = "You can pay in cash at the physical location of the vehicle.\n" \
               "Pay at checkout, and give this id to the driver:\n" \
               "<b>{user_cash_id}</b>"
...
bot_info = 'This bot is programmed using python found <a href="https://github.com/Jerryblessed">here</a>,' \
           ' The bot uses a framework for Telegram payments released under the' \
           ' <a href="https://github.com/Steffo99/greed/blob/master/LICENSE.txt">' \
           'Affero General Public License 3.0</a>.\n'

# Help: guide
help_msg = "IBTROS's guide is available at this address:\n" \
           "https://github.com/Jerryblessed"
...
# Success: vehicle has been added/edited to the database
success_product_edited = "✅ The vehicle has been successfully added/modified!"

# Success: vehicle has been added/edited to the database
success_product_deleted = "✅ The vehicle has been successfully deleted!"
...
error_duplicate_name = "️⚠️ A vehicle with the same name already exists."
