...
# vehicle information
vehicle_format_string = "<b>{name}</b>\n" \
                        "{description}\n" \
                        "{price}\n" \
                        "<b>{cart}</b>"
...
conversation_admin_select_vehicle = "✏️ What vehicle do you want to edit?"

# Conversation: select a vehicle to delete
conversation_admin_select_vehicle_to_delete = "❌ What vehicle do you want to delete?"
...
conversation_confirm_cart = "Confirm the number of booked space(s) for the following vehicle(s):\n" \
                            "{product_list}" \
...
conversation_confirm_admin_promotion = "Are you sure you want to promote this user to 💼 pilot?\n" \
...
menu_add_vehicle = "✨ New vehicle"

# Admin menu: delete vehicle
menu_delete_vehicle = "❌ Delete vehicle"
...
# Add vehicle: name?
ask_vehicle_name = "What should the vehicle name be?"

# Add vehicle: description?
ask_vehicle_description = "What should the vehicle description be?"

# Add vehicle: price?
ask_vehicle_price = "What should the fare be for this vehicle ride?\n" \
                    "Enter <code>X</code> if don't want the vehicle ride to have a price."

# Add vehicle: image?
ask_vehicle_image = "🖼 What image do you want the vehicle to have?\n" \
                    "\n" \
...
prop_edit_vehicles = "Edit vehicles"
...
payment_cash = "You can pay in cash at the physical location of the shuttle.\n" \
               "Pay at shuttle point, and give this id to the driver:\n" \
               "<b>{user_cash_id}</b>"
...
success_vehicle_edited = "✅ The vehicle has been successfully added/modified!"

# Success: vehicle has been added/edited to the database
success_vehicle_deleted = "✅ The vehicle has been successfully deleted!"
